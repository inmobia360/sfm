...
El contrato que deberá cumplir ese sustituto está detallado en `docs/PRODUCTION-REPOSITORY-CONTRACT.md`, incluyendo concurrencia, idempotencia, auditoría transaccional y evidencias de migración/restauración.
