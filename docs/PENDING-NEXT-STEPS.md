...
5. GitHub Actions verificado externamente: CI pasa en `e0ef590`, pero Pages falla en `Configure Pages` antes de generar el artefacto (run `35200960879`), y `https://inmobia360.github.io/sfm/launch.html` devuelve 404. Habilitar GitHub Pages manualmente desde Settings → Pages con **GitHub Actions** y repetir el workflow; no es un fallo del artefacto ni de las pruebas locales.
