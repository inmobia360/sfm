...
for (const route of ['/v1/me', '/v1/attendance/events', '/v1/tasks/{taskId}/complete', '/v1/incidents', '/v1/approvals', '/v1/approvals/{approvalId}/decision', '/v1/audit-events']) assert.match(text, new RegExp(route.replace(/[{}]/g, '\\$&')));
