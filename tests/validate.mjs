...
const required = [
  ...
  'package.json', 'docs/agents/shared-state.md', 'docs/agents/role-enforcement.md', 'docs/agents/message-envelope.md', 'docs/agents/runtime-guide.md', 'src/agent-envelope.mjs', 'src/agent-router.mjs', 'src/task-state.mjs', 'src/agent-runtime.mjs', 'src/audit-log.mjs', 'src/agent-registry.mjs', 'src/access-policy.mjs', 'src/metrics.mjs', 'src/approval-gate.mjs', 'tests/envelope.test.mjs', 'tests/router.test.mjs', 'tests/task-state.test.mjs', 'tests/runtime.test.mjs', 'tests/audit-log.test.mjs', 'tests/agent-registry.test.mjs', 'tests/access-policy.test.mjs', 'tests/metrics.test.mjs', 'tests/approval-gate.test.mjs', 'specs/001-sfm-mvp/spec.md'
];
const failures = [];
