...
const required = [
  ...
  'docs/agents/shared-state.md', 'docs/agents/role-enforcement.md', 'docs/agents/message-envelope.md', 'src/agent-envelope.mjs', 'src/agent-router.mjs', 'tests/envelope.test.mjs', 'tests/router.test.mjs', 'specs/001-sfm-mvp/spec.md'
];
const failures = [];
