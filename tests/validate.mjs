...
const required = [
  ...
  'docs/agents/constitution.md', 'docs/agents/authority-matrix.md', 'docs/PRODUCTION-BOUNDARY.md', 'docs/PRODUCTION-API-CONTRACT.md', 'src/production-guard.mjs', 'src/request-context.mjs', 'src/request-authorization.mjs', 'tests/production-guard.test.mjs', 'tests/api-contract-doc.test.mjs', 'tests/request-context.test.mjs', 'tests/request-authorization.test.mjs',
