...
required.push('scripts/demo-server.mjs', 'tests/demo-server.test.mjs', 'tests/production-decision-gate.test.mjs', 'docs/PRODUCTION-DECISION-GATE.md', 'docs/PRODUCTION-REPOSITORY-CONTRACT.md');
const failures = [];
