...
const required = [
  ...
  'docs/agents/constitution.md', 'docs/agents/authority-matrix.md', 'docs/PRODUCTION-BOUNDARY.md', 'docs/PRODUCTION-API-CONTRACT.md', 'src/production-guard.mjs', 'src/request-context.mjs', 'src/request-authorization.mjs', 'src/governed-action.mjs', 'src/production-api-handler.mjs', 'src/scoped-repository.mjs', 'tests/production-guard.test.mjs', 'tests/api-contract-doc.test.mjs', 'tests/request-context.test.mjs', 'tests/request-authorization.test.mjs', 'tests/governed-action.test.mjs', 'tests/production-api-handler.test.mjs', 'tests/scoped-repository.test.mjs', 'tests/workflow-safety.test.mjs', 'tests/demo-safety.test.mjs',
