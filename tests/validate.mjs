...
const required = [
  ...
  'package.json', 'docs/agents/shared-state.md', 'docs/agents/role-enforcement.md', 'docs/agents/message-envelope.md', 'docs/agents/runtime-guide.md', 'docs/agents/implementation-map.md', 'src/agent-envelope.mjs', 'src/agent-router.mjs', 'src/task-state.mjs', 'src/agent-runtime.mjs', 'src/agent-system.mjs', 'src/health-check.mjs', 'src/audit-log.mjs', 'src/audit-subscriber.mjs', 'src/alert-subscriber.mjs', 'src/agent-registry.mjs', 'src/access-policy.mjs', 'src/metrics.mjs', 'src/approval-gate.mjs', 'src/event-bus.mjs', 'tests/envelope.test.mjs', 'tests/router.test.mjs', 'tests/task-state.test.mjs', 'tests/runtime.test.mjs', 'tests/agent-system.test.mjs', 'tests/health-check.test.mjs', 'tests/audit-log.test.mjs', 'tests/audit-subscriber.test.mjs', 'tests/alert-subscriber.test.mjs', 'tests/agent-registry.test.mjs', 'tests/access-policy.test.mjs', 'tests/metrics.test.mjs', 'tests/approval-gate.test.mjs', 'tests/event-bus.test.mjs', 'specs/001-sfm-mvp/spec.md'
];
const failures = [];
