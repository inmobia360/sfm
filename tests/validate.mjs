...
required.push('scripts/demo-server.mjs', 'scripts/prepare-pages.mjs', 'tests/demo-server.test.mjs', 'tests/pages-artifact.test.mjs', 'tests/production-decision-gate.test.mjs', 'docs/PRODUCTION-DECISION-GATE.md', 'docs/PRODUCTION-REPOSITORY-CONTRACT.md');
const failures = [];
