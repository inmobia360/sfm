...
export const publicFiles = ['launch.html', 'index.html', 'ceo.html', 'scenarios.html', 'worker.html', 'training.html', 'report.html', 'audit.html', 'notifications.html', 'integrations.html', 'styles.css', 'data.js', 'agent-config.json'];
